    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/**").hasAnyRole("MANAGER", "STAFF")
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/pos").hasRole("MANAGER")
                        .requestMatchers(HttpMethod.POST, "/api/pos/*/submit", "/api/pos/*/receive", "/api/pos/*/cancel").hasRole("MANAGER")
                        .requestMatchers(HttpMethod.PUT, "/api/pos/**").hasRole("MANAGER")
                        .requestMatchers(HttpMethod.PUT, "/api/reference/**").hasRole("MANAGER")
                        .requestMatchers(HttpMethod.GET, "/api/reports/export.csv").hasRole("MANAGER")
