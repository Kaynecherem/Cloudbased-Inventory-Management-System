...
public interface StockMovementRepository extends JpaRepository<StockMovement, Long>, JpaSpecificationExecutor<StockMovement> {
    ...
    @Query("""
            ...
            """)
    List<UsageReportItem> findUsageReport(@Param("from") Instant from, @Param("to") Instant to, Pageable pageable);
    ...
    @Query("""
            ...
            """)
    List<TopMoverItem> findTopMovers(@Param("from") Instant from, @Param("to") Instant to, Pageable pageable);
